...
async def run_python_code(
    ...
    Args:
        ...
        sandbox_id: The id of the sandbox to run the code in. Reuse existing sandboxes whenever possible.
            Only create new ones if this is the first time running code in this sandbox.
